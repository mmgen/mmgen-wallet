...
class unit_tests:
	...
	def sig_errors(self, name, ut):
		...
		bad_data = (
			...
			('sign: bad msghash len',    'ValueError',     'hash length',                  sign2),
			...
			('verify: bad msghash len',  'ValueError',     'message hash length',          verify5),
			('verify: bad sig len',      'ValueError',     'Invalid signature length',     verify6),
			('recover: bad args',        'ValueError',     'Unable to parse',              recov1),
			('recover: bad recid',       'ValueError',     'Invalid recovery ID',          recov2),
			('recover: bad recid',       'ValueError',     'Invalid recovery ID',          recov3),
